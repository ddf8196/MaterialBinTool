 ...
 * @see com.ddf.materialbintool.thirdparty.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADCipher
{
     ...
     * @throws com.ddf.materialbintool.thirdparty.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
