...
import static com.ddf.materialbintool.thirdparty.anarres.cpp.PreprocessorCommand.*;
import com.ddf.materialbintool.thirdparty.anarres.cpp.PreprocessorListener.SourceChangeEvent;
import static com.ddf.materialbintool.thirdparty.anarres.cpp.Token.*;
        ...
        for (;;) {
            ...
            switch (tok.getType()) {
                ...
                case HASH:
                    ...
                    PreprocessorCommand ppcmd = forText(tok.getText());
                    if (ppcmd == null) {
                        error(tok,
